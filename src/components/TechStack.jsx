        ...
        <section id="techstack" className="section-techstack">
            ...
            <div className="box">
                <div className="box__left">
                    <h3 className="heading-tertiary font-size-medium">Frontend is my FORTE! <Icon icon={flexedBiceps} /></h3>
                    <p>Throughout my CS journey I have spent time learning, prototyping and coding frontend for web applications. I started my journey learning about basics of HTML and CSS. To be frank, I jumped on Angular before understanding the fundamentals of Javascript. Sooner I started to face challenges 🐣🤦‍♂️ writing code in Angular which pushed me to learn Vanilla JS. Thanks to Brad's Modern Javascript Course. After getting my hands dirty on JS, I revisited Angular and spent some time exploring features of typescript. Developed some applications which included Firebase backend and serverless firebase functions written in Node. After Learning Angular it was obvious that I would go to Ionic for Mobile Applications. Recently I figured out that React.JS is emerging to be popular amongst frontend frameworks. So I did my certification in React from Edureka. Now I spend most of my time with React and SASS.</p>
                </div>
